      ...
      <section className="w-full bg-[#E5F5F5] pt-8 sm:pt-10 lg:pt-[52px] pb-16 sm:pb-20 lg:pb-24 border-b border-[#D9E4E4]">
        <div className="w-full max-w-[1440px] mx-auto px-6 sm:px-10 lg:px-16 xl:px-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-6 xl:gap-8">
            ...
            <div className="bg-[#FCFCFB] p-7 sm:p-8 rounded-2xl border border-[#D9E4E4] shadow-sm flex flex-col text-left space-y-4 h-full">
              ...
              <p className="text-sm sm:text-[15px] text-[#30383D] leading-relaxed font-normal">
                Make mobile money more accessible with convenient Pickup and Delivery services that fit Customers’ everyday needs.
              </p>
            </div>
            ...
            <div className="bg-[#FCFCFB] p-7 sm:p-8 rounded-2xl border border-[#D9E4E4] shadow-sm flex flex-col text-left space-y-4 h-full">
              ...
              <p className="text-sm sm:text-[15px] text-[#30383D] leading-relaxed font-normal">
                Capture everyday walk-in and requested transactions in real time, giving Business Owners a clear view of Agent activity and business operations.
              </p>
            </div>
            ...
            <div className="bg-[#FCFCFB] p-7 sm:p-8 rounded-2xl border border-[#D9E4E4] shadow-sm flex flex-col text-left space-y-4 h-full">
              ...
              <p className="text-sm sm:text-[15px] text-[#30383D] leading-relaxed font-normal">
                Manage Agents, transactions, liquidity and daily operations from one connected platform, with the information you need to make better decisions.
              </p>
            </div>
            ...
            <div className="bg-[#FCFCFB] p-7 sm:p-8 rounded-2xl border border-[#D9E4E4] shadow-sm flex flex-col text-left space-y-4 h-full">
              ...
              <p className="text-sm sm:text-[15px] text-[#30383D] leading-relaxed font-normal">
                Help Agents maintain the working capital they need to serve Customers and keep their mobile-money operations running smoothly.
              </p>
            </div>
