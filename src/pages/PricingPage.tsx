...
export default function PricingPage({ onGetTellerBud, onNavigate }: PricingPageProps) {
  ...
  return (
    <div className="w-full bg-[#FCFCFB] text-[#182026]">
      ...
      {/* PRICING PAGE HERO                                  */}
      {/* ================================================== */}
      <section className="relative w-full bg-gradient-to-b from-[#EBF7F7]/70 via-[#FCFCFB] to-[#FCFCFB] border-b border-[#DDE7E7]/60 pt-20 sm:pt-24 lg:pt-[92px] pb-20 sm:pb-24 lg:pb-[92px] overflow-visible">
        ...
        <div className="relative z-10 w-full max-w-[1400px] mx-auto px-6 sm:px-8 md:px-12 text-center overflow-visible">
          {/* Headline: Completely visible on one single line on desktop (54–60px) with refined letter-spacing */}
          <h1 className="font-heading font-semibold text-[#090D10] tracking-[-0.02em] text-center mx-auto text-[34px] sm:text-[38px] md:text-[44px] lg:text-[clamp(44px,3.8vw,52px)] xl:text-[clamp(52px,3.9vw,60px)] leading-[1.16] xl:whitespace-nowrap max-w-none overflow-visible">
            Simple pricing. Powerful business support.
          </h1>

          {/* Supporting Text: Centered below headline with 28-34px spacing and 850-950px max width */}
          <p className="mt-7 sm:mt-8 text-base sm:text-lg lg:text-[19px] xl:text-xl text-[#30383D] leading-relaxed max-w-[920px] mx-auto font-normal">
      ...
      {/* ================================================== */}
      <section className="w-full py-14 sm:py-16 lg:py-20 bg-[#E8F6F6] border-y border-[#008C95]/20">
        <div className="w-full max-w-[1480px] mx-auto px-5 sm:px-6 md:px-8 lg:px-16 xl:px-20 2xl:px-24 space-y-8 lg:space-y-10">
          <div className="space-y-4 max-w-4xl text-left">
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#FCFCFB] text-[#005F67] text-xs font-semibold tracking-wider uppercase border border-[#008C95]/20 shadow-2xs">
          ...
          <div className="space-y-4 text-left">
            <h3 className="text-xs sm:text-sm font-semibold uppercase tracking-wider text-[#005F67]">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3.5 sm:gap-4">
              {[
                ...
                <div
                  key={idx}
                  className="flex items-center gap-3 bg-[#FCFCFB] border border-[#D0E5E5] rounded-xl px-5 py-4 text-sm sm:text-[15px] font-medium text-[#182026] shadow-2xs hover:border-[#008C95]/40 transition-colors"
                >
          ...
          <div className="pt-6 border-t border-[#008C95]/20 text-left">
            <p className="text-sm sm:text-base text-[#30383D] leading-relaxed max-w-4xl font-normal">
      ...
      {/* ================================================== */}
      <section className="w-full py-14 sm:py-16 lg:py-20 bg-[#FCFCFB]">
        <div className="w-full max-w-[1480px] mx-auto px-5 sm:px-6 md:px-8 lg:px-16 xl:px-20 2xl:px-24">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 xl:gap-16 items-start">
            {/* Left Column: Device Terms (approx 42-45%) */}
            ...
            {/* Right Column: Device Loss or Theft Panel (approx 55-58%) */}
            <div className="lg:col-span-7 rounded-2xl border border-[#D9E4E4] bg-[#FFFFFF] p-7 sm:p-9 lg:p-10 shadow-2xs space-y-5 text-left">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-xl bg-[#E5F5F5] border border-[#008C95]/20 flex items-center justify-center text-[#008C95] shrink-0">
              ...
              <div className="space-y-3.5 text-base text-[#30383D] leading-relaxed font-normal">
      ...
      {/* ================================================== */}
      <section className="w-full py-14 sm:py-16 lg:py-20 bg-[#F8FBFA] border-y border-[#DDE7E7]">
        <div className="w-full max-w-[1480px] mx-auto px-5 sm:px-6 md:px-8 lg:px-16 xl:px-20 2xl:px-24">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 xl:gap-16 items-center">
            {/* Left Column: Large Amount Treatment (approx 33%) */}
            <div className="lg:col-span-4 bg-[#FFFFFF] border border-[#D9E4E4] rounded-3xl p-8 sm:p-10 lg:p-11 text-center space-y-5 shadow-2xs">
              ...
              <p className="text-xs sm:text-sm text-[#30383D]/80 leading-relaxed pt-3 border-t border-[#EBF0F0]">
                Predictable monthly support with no hidden maintenance fees
              </p>
            </div>

            {/* Right Column: Editorial Details (approx 67%) */}
            <div className="lg:col-span-8 space-y-6 text-left">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-1">
                {[
                  ...
                  <div key={idx} className="flex items-center gap-3 text-sm sm:text-base text-[#182026] bg-[#FFFFFF]/70 sm:bg-transparent p-2 sm:p-0 rounded-lg">
                    <CheckCircle2 className="w-4 h-4 text-[#008C95] shrink-0" />
                    <span>{item}</span>
                  </div>
                ))}
              ...
              <p className="text-sm sm:text-base text-[#30383D] font-medium pt-3 border-t border-[#DDE7E7]">
      ...
      <section className="w-full py-14 sm:py-16 lg:py-20 bg-[#FCFCFB]">
        <div className="w-full max-w-[1480px] mx-auto px-5 sm:px-6 md:px-8 lg:px-16 xl:px-20 2xl:px-24">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-10 xl:gap-12">
            {/* SECTION 5 — TRANSACTION FEES (50%) */}
            <div className="bg-[#FFFFFF] border border-[#D9E4E4] rounded-3xl p-8 sm:p-10 lg:p-12 shadow-2xs space-y-6 flex flex-col justify-between hover:border-[#008C95]/40 transition-all text-left">
              <div className="space-y-6">
                ...
                <div className="space-y-3.5 text-sm sm:text-base text-[#30383D] leading-relaxed font-normal">
                  <p>
            ...
            {/* SECTION 6 — PICKUP & DELIVERY SERVICE FEE (50%) */}
            <div className="bg-[#FFFFFF] border border-[#D9E4E4] rounded-3xl p-8 sm:p-10 lg:p-12 shadow-2xs space-y-6 flex flex-col justify-between hover:border-[#008C95]/40 transition-all text-left">
              <div className="space-y-6">
                <div className="flex items-center justify-between">
                  <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#E5F5F5] text-[#005F67] text-xs font-semibold tracking-wider uppercase">
      ...
      {/* ================================================== */}
      <section className="w-full py-14 sm:py-16 lg:py-16 bg-[#FCFCFB] border-t border-[#DDE7E7]">
        <div className="w-full max-w-[1480px] mx-auto px-5 sm:px-6 md:px-8 lg:px-16 xl:px-20 2xl:px-24">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-12 xl:gap-16 items-start">
            {/* Left Column: 25-30% */}
            <div className="lg:col-span-3 xl:col-span-3 text-left">
              <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#E5F5F5] text-[#005F67] text-xs font-semibold tracking-wider uppercase border border-[#008C95]/20">
                <FileText className="w-3.5 h-3.5 text-[#008C95]" />
                <span>SERVICE TERMS</span>
              </div>
            </div>

            {/* Right / Main Column: 70-75% */}
            <div className="lg:col-span-9 xl:col-span-9 space-y-4 text-left">
              <div className="space-y-3.5 sm:space-y-4 text-sm sm:text-base text-[#30383D] leading-relaxed font-normal max-w-4xl">
                <p>
      ...
      {/* FINAL CTA BAND                                     */}
      {/* ================================================== */}
      <section className="w-full bg-[#005F67] text-[#FCFCFB] py-16 sm:py-20 lg:py-24 relative overflow-hidden">
        <div className="w-full max-w-[1360px] mx-auto px-5 sm:px-6 md:px-8 lg:px-16 xl:px-20 2xl:px-24 text-center relative z-10 space-y-6 sm:space-y-7">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#FCFCFB]/15 text-[#FCFCFB] text-xs font-semibold tracking-wider uppercase border border-[#FCFCFB]/20 shadow-2xs">
            <Sparkles className="w-3.5 h-3.5 text-[#FCFCFB]" />
            <span>START WITH TELLERBUD</span>
          </div>

          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-semibold text-[#FCFCFB] tracking-tight max-w-[960px] mx-auto leading-tight">
            A smarter way to manage your mobile-money business.
          </h2>

          {/* Pricing Summary Display - Single horizontal line on desktop */}
          <div className="py-2 max-w-[1100px] mx-auto">
            <p className="text-sm sm:text-base lg:text-[17px] font-semibold text-[#E5F5F5] tracking-wide inline-flex flex-wrap items-center justify-center gap-x-2.5 sm:gap-x-3 gap-y-1.5 leading-relaxed">
              <span className="whitespace-nowrap">K250 setup</span>
              <span className="text-[#E5F5F5]/60">•</span>
              <span className="whitespace-nowrap">14 days free</span>
              <span className="text-[#E5F5F5]/60">•</span>
              <span className="whitespace-nowrap">K100/month</span>
              <span className="text-[#E5F5F5]/60">•</span>
              <span className="whitespace-nowrap">K0.10 per transaction</span>
              <span className="text-[#E5F5F5]/60">•</span>
              <span className="whitespace-nowrap">Device provided at no upfront cost</span>
            </p>
          </div>
